...
public sealed class PackageTask : FrostingTask<BuildContext>
{
    public override void Run(BuildContext context)
    {
        context.EnsureDirectoryExists("../RELEASE_DIR");
        ...
        {
            context.CopyFile($"../{BuildContext.ProjectName}/modicon.png", $"../RELEASE_DIR/{context.Name}/modicon.png");
        }
        context.Zip($"../RELEASE_DIR/{context.Name}", $"../RELEASE_DIR/{context.Name}_{context.Version}.zip");
    }
}
